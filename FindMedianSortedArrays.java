...
Time Complexity: O(min(log(x, y))), where x and y are lengths of the nums1, nums2 respectively
...
public class FindMedianSortedArrays {
    public static double findMedianSolution(int[] nums1, int[] nums2) {
        ...
        while(start <= end)
        {
            ...
            int yPartition = (xlength + ylength + 1) / 2 - xPartition;       
            ...
            int minRightX = (xPartition == xlength) ? Integer.MAX_VALUE : nums1[xPartition];
            ...
            int minRightY = (yPartition == ylength) ? Integer.MAX_VALUE : nums2[yPartition];
